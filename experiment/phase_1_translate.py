...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Phase 1: Data Cleaning (school name translation).")
    ...
    parser.add_argument("--skip-translate", action="store_true", help="Skip the translation process.")
    return parser
